		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#namespace1projectprodapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespace1projectprodapp-display": {
								"semanticObject": "namespace1projectprodapp",
								"action": "display",
								"description": "An SAP Fiori application. Product App Test",
								"title": "Product App Test",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace1.projectprodapp",
									"url": sap.ui.require.toUrl("namespace1/projectprodapp")
								}
							}
						}
					}
